...
Napi::Value getLicenseEntitlementSetTier(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
    if (info.Length() < 1)
    {
    ...
    return Napi::Number::New(env, GetLicenseEntitlementSetTier(arg0));
}
...
Napi::Value getActivationCreationDate(const Napi::CallbackInfo &info)
{
    Napi::Env env = info.Env();
    if (info.Length() < 1)
    {
    ...
    Napi::Uint32Array array = info[0].As<Napi::Uint32Array>();
    uint32_t *arg0 = reinterpret_cast<uint32_t *>(array.ArrayBuffer().Data());
    return Napi::Number::New(env, GetActivationCreationDate(arg0));
}
...
Napi::Object Init(Napi::Env env, Napi::Object exports)
{
    ...
    exports["GetLicenseEntitlementSetTier"] = Napi::Function::New(env, getLicenseEntitlementSetTier);
