...
const updateLibrary = function(path) {
	LexActivatorNative = new FFI.Library(path, {
...
var LexActivatorNative;

updateLibrary(libraryPath);
...
module.exports = { LexActivatorNative, LicenseCallback, SoftwareReleaseUpdateCallback, getStringBuffer, bufferToString, updateLibrary };
